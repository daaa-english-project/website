    ...
    .then(([geometryData, infoData]) => {
        ...
        L.geoJSON(geometryData, {
            ...
            onEachFeature: (feature, layer) => {
                ...
                if (additionalInfo) {
                    popupContent += `<p><b>Population :</b> ${additionalInfo.POPULATION || 'No data'}`;
                    popupContent += `<br><b>GDP :</b> ${additionalInfo.GDP || 'No data'}`;
                    popupContent += `<br><b>Capital :</b> ${additionalInfo.CAPITAL || 'No data'}`;
                    popupContent += `<br><b>Area :</b> ${additionalInfo.AREA || 'No data'} km²</p>`;
                } else {
